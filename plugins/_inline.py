...
SUP_BUTTONS = [
    [
        Button.url("Repo", url="😂https://t.me/paytm_money_earning_loots_offars"),
        Button.url("Addons", url="https://t.me/paytm_money_earning_loots_offars"),
    ],
    [Button.url("Support", url="t.me/paytm_money_earning_loots_offars")],
]
